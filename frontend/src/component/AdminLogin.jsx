...
/* ---------------- Hero (minimal padding, like user login) ---------------- */
function Hero() {
  return (
    <section className="relative pt-0 pb-8 md:pt-2 md:pb-12 overflow-hidden bg-[#f8fafc]">
      ...
      <div className="relative max-w-4xl mx-auto px-6 md:px-10 text-center">
        ...
        <p className="font-[Inter] text-lg text-[#1e293b]/80 max-w-2xl mx-auto leading-relaxed mt-2">
          Manage water points, reports, users, and platform settings.
        </p>
      </div>
    </section>
  );
    ...
    <div className="max-w-md mx-auto px-6 md:px-10 pb-20">
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
        <div className="flex items-center gap-3 mb-8">
          <div className="w-12 h-12 rounded-xl bg-[#0e4c93]/10 flex items-center justify-center">
            <Shield className="w-6 h-6 text-[#0e4c93]" />
          </div>
          <div>
            ...
            <div className="flex items-center gap-2 mt-0.5">
              ...
              <span className="text-[10px] font-[Inter] font-semibold uppercase tracking-wider bg-[#0e4c93]/10 text-[#0e4c93] px-2 py-0.5 rounded-full">
                Admin
              </span>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full font-[Inter] text-sm bg-[#f8fafc] border border-slate-200 rounded-xl pl-11 pr-4 py-3 outline-none focus:border-[#0e4c93] transition-colors text-[#1e293b]"
                placeholder="admin@newatertracker.ke"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full font-[Inter] text-sm bg-[#f8fafc] border border-slate-200 rounded-xl pl-11 pr-11 py-3 outline-none focus:border-[#0e4c93] transition-colors text-[#1e293b]"
                placeholder="••••••••"
              />
              <button
                type="button"
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
                className="rounded border-slate-300 text-[#0e4c93] focus:ring-[#0e4c93] focus:ring-2"
              />
              <span className="font-[Inter] text-xs text-[#1e293b]/70">Remember me</span>
            </label>
            <a
              href="#"
              className="font-[Inter] text-xs text-[#0e4c93] hover:underline"
            >
              Forgot password?
            </a>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full font-[Inter] font-medium text-sm px-6 py-3.5 rounded-full bg-[#0e4c93] text-white hover:bg-[#0a3d7a] transition-colors disabled:opacity-60 inline-flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
          >
            {loading ? (
          ...
          <p className="font-[Inter] text-xs text-[#1e293b]/50 text-center">
            Only authorised system administrators can access this page.
          </p>
        </form>
        ...
        <div className="mt-6 text-center border-t border-slate-100 pt-6">
          <p className="font-[Inter] text-xs text-[#1e293b]/60">
            ...
            <Link
              to="/user-login"
              className="text-[#1565C0] hover:underline font-medium inline-flex items-center gap-1"
            >
